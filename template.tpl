...

{
  ...
  "description": "Include this tag and then add the relevant data in your datalayer as described here : https://www.kelkoogroup.com/kelkoo-customer-service/support-for-merchants/sales-tracking-guides/google-tag-manager",
  "containerContexts": [
    "WEB"
  ]
}
...
data.gtmOnSuccess();
// Call data.gtmOnFailure when the tag is finished.
data.gtmOnFailure();
// log to console
...
You must add in your "Thank you page" (the page displayed after customer payment) the following datalayer (or add it in your existing datalayer):
...
ORDER_ID: any string identifying the order. This value must be unique for each order

"returningUser" allow you to tell if it is a returning user or a new user. It is optional to provide it.

"basket" allow you to provide the customer basket details.
...
PRODUCTx_PRICE: any real number with dot as decimal point representing the price of the single product. Please do not add currency symbol.
